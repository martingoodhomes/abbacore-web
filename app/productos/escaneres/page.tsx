    ...
    products: [
      {
        ...
        features: ['70 ppm / 140 ipm a 300 dpi', 'ADF 80 hojas · A4 · Dúplex', 'Active Feed Technology', 'Ciclo diario 10,000 páginas', 'Detección ultrasónica de doble alimentación', 'Capture Pro — Edición Limitada y Smart Touch'],
      },
      {
        ...
        features: ['80 ppm / 160 ipm · Wi-Fi dual band', 'ADF 80 hojas · Formato A4', 'Ciclo diario 12,000 páginas', 'Smart Touch con 7 destinos', 'Diseño compacto de carga frontal', 'Integración con nube (SharePoint, Google Drive)'],
      },
      {
        ...
        Icon: ScanLine,
        description: 'Escáner inalámbrico de 60 ppm para grupos de trabajo medianos. Combina velocidad, conectividad Wi-Fi y tarjeta de red para integrarse sin fricción en la infraestructura corporativa.',
        features: ['60 ppm / 120 ipm', 'Wi-Fi integrado · ADF 80 hojas', 'Ciclo diario 10,000 páginas', 'Smart Touch — escaneo con un botón', 'Active Feed Technology', 'Tarjeta de red'],
      },
      {
        ...
        features: ['40 ppm / 80 ipm · Dual CIS', 'DirectScan — escaneo sin PC', 'Pantalla táctil 4.3" integrada', 'ADF 50 hojas · A4', 'Tarjeta de red incorporada', 'Ciclo diario 6,000 páginas'],
      },
      {
        ...
        features: ['50 ppm / 100 ipm · Dual CIS', 'ADF 100 hojas · A4', 'Clear Image Capture (CIC)', 'Detección ultrasónica de doble alimentación', 'USB 3.2 Gen 1 · Tarjeta de red', 'PaperStream Capture incluido'],
      },
      {
        ...
        features: ['70 ppm / 140 ipm', 'Dual CIS · ADF 100 hojas', 'Clear Image Capture', 'Detección inteligente de rotura de papel', 'USB 3.2 Gen 1 · Tarjeta de red', 'Ciclo 10,000 páginas/día'],
      },
      {
        ...
        features: ['90 ppm / 180 ipm · Dual CIS', 'ADF 100 hojas · A4', 'Clear Image Capture', 'Ciclo 13,000 páginas/día', 'Categoría de mayor velocidad en segmento', 'USB 3.2 + LAN'],
      },
      {
      ...
      },
      {
        ...
        Icon: ScanLine,
        description: 'Escáner de grupo de trabajo de alta velocidad para digitalización masiva. ADF de 100 hojas y 65 ppm para flujos de trabajo exigentes.',
        features: ['65 ppm / 130 ipm · A4', 'ADF 100 hojas', 'USB 3.0', 'Ciclo diario 10,000 páginas', 'Compatible TWAIN/ISIS/WIA', 'Resolución óptica 600 dpi'],
      },
      {
        ...
        features: ['85 ppm / 170 ipm · A4', 'ADF 100 hojas · Dúplex', 'Resolución 600 dpi óptico', 'USB 3.0', 'Ciclo diario 14,000 páginas', 'Compatible TWAIN/ISIS/WIA'],
      },
      {
        name: 'Epson DS-800WN', brand: 'Epson', brandColor: '#2563eb',
        spec: '50 ppm / 100 ipm · Ethernet · Wi-Fi · A3',
        image: '/products/scanners/epson-ds-800wn.jpg',
        Icon: ScanLine,
        description: 'Escáner A3 de red para grupos de trabajo que manejan formatos grandes. Conectividad Ethernet y Wi-Fi para compartir el escáner en red y escanear directamente a carpetas compartidas.',
        features: ['50 ppm / 100 ipm · Formato A3', 'USB 3.0 de alta velocidad · Ethernet · Wi-Fi', 'Ciclo diario 8,000 páginas', 'Resolución 600 dpi', 'Dúplex automático', 'Compatible con TWAIN/ISIS'],
      },
      {
        name: 'Brother ADS-4300N', brand: 'Brother', brandColor: '#0072CE',
        spec: '40 ppm / 80 ipm · LAN · ADF 80 hojas',
        image: '/products/scanners/brother-ads-4300n.jpg',
        Icon: ScanLine,
        description: 'Escáner de red cableado de alta velocidad para grupos de trabajo. Con 40 ppm, ADF de 80 hojas y conectividad USB 3.0 y Ethernet, escanea directamente a SharePoint, OneDrive, FTP y más.',
        features: ['40 ppm / 80 ipm · Dúplex automático', 'ADF 80 hojas · Formato A4', 'USB 3.0 · Tarjeta de Red Ethernet', 'Escaneo directo a nube y carpetas de red', 'Resolución óptica 600 dpi', 'Ciclo diario 6,000 páginas'],
      },
      {
        name: 'Brother ADS-4700W', brand: 'Brother', brandColor: '#0072CE',
        spec: '40 ppm / 80 ipm · Wi-Fi · Pantalla táctil 4.3"',
        image: '/products/scanners/brother-ads-4700w.jpg',
        Icon: ScanLine,
        description: 'Escáner inalámbrico con pantalla táctil de 4.3" para operación autónoma. Escanea a email, SharePoint, OneDrive, FTP y más — vía Wi-Fi.',
        features: ['40 ppm / 80 ipm · Dúplex automático', 'Wi-Fi + LAN + USB · ADF 50 hojas', 'Pantalla táctil 4.3"', 'Escaneo directo a nube, USB y correo', 'Resolución óptica 600 dpi', 'Ciclo diario 6,000 páginas'],
      },
      {
        ...
        Icon: ScanLine,
        description: 'El escáner de grupo de trabajo más potente de Brother. Con 60 ppm, ADF de 80 hojas, pantalla táctil de 4.3" y conectividad completa, es la solución ideal para departamentos de alto volumen.',
        features: ['60 ppm / 120 ipm · Dúplex automático', 'ADF 80 hojas · Formato A4', 'Wi-Fi + LAN + USB · Pantalla táctil 4.3"', 'Escaneo directo a nube y carpetas de red', 'Resolución óptica 600 dpi', 'Ciclo diario 9,000 páginas'],
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        Icon: ScanLine,
        description: 'Escáner de producción de ciclo continuo para operaciones 24/7. Maneja hasta 45,000 páginas/día con total confiabilidad gracias a su tecnología de alimentación industrial.',
        features: ['100 ppm / 200 ipm · A3', 'ADF 300 hojas', 'Uso 24/7 continuo', 'Ciclo diario 45,000 páginas', 'Active Feed Technology industrial', 'Integración con plataformas de captura BPO'],
      },
      {
      ...
      },
      {
        ...
        spec: '100 ppm / 200 ipm · A3 · ADF 300 hojas',
        image: '/products/scanners/ricoh-fi-7700.jpg',
        Icon: ScanLine,
        description: 'Escáner de producción versátil con ADF de 300 hojas y soporte A3. Escaneo dúplex a 100 ppm con Sensores CCD para imágenes perfectas en ambas caras.',
        features: ['100 ppm / 200 ipm · A3', 'ADF 300 hojas · Sensores CCD', 'Ciclo 44,000 páginas/día', 'USB 3.0', 'Cama plana incorporada de 12" x 18"', 'Máxima protección de papel — Trayectoria en línea recta'],
      },
      {
        name: 'Ricoh fi-7600', brand: 'Ricoh', brandColor: '#A0153E',
        spec: '100 ppm / 200 ipm · A3 · USB 3.0',
        image: '/products/scanners/ricoh-fi-7600.jpg',
        Icon: ScanLine,
        description: 'Escáner de producción A3 de alto rendimiento para centrales de digitalización. Escaneo a 100 ppm con Sensores CCD y trayectoria en línea recta para máxima protección del documento.',
        features: ['100 ppm / 200 ipm · A3', 'USB 3.0', 'ADF 300 hojas · Sensores CCD', 'Máxima protección de papel — Trayectoria en línea recta', 'Ciclo 44,000 páginas/día', 'Compatible PaperStream Capture'],
      },
      {
        name: 'Ricoh fi-8820', brand: 'Ricoh', brandColor: '#A0153E',
        spec: '120 ppm / 240 ipm · A3 · Producción continua',
        image: '/products/scanners/ricoh-fi-8820.png',
        Icon: ScanLine,
        description: 'Escáner de línea de producción continua con 120 ppm para entornos BPO y centros de procesamiento masivo. Disponibilidad 24/7 con sistemas avanzados de control de imagen.',
        features: ['120 ppm / 240 ipm · A3', 'Producción continua 24/7', 'ADF 500 hojas', 'Control avanzado de imagen', 'Compatible PaperStream Capture Pro', 'Ciclo 100,000 páginas/día'],
      },
      {
        ...
        features: ['130 ppm / 260 ipm · A3', 'LAN integrada para red', 'ADF 750 hojas', 'Clear Image Capture', 'Compatible PaperStream Capture Pro', 'Ciclo diario 110,000 páginas'],
      },
      {
        ...
        features: ['150 ppm / 300 ipm · A3', 'ADF 750 hojas', 'Línea de producción continua', 'Control avanzado de alimentación', 'Mayor velocidad del segmento Ricoh', 'Ciclo 120,000 páginas/día'],
      },
    ],
  },
]
